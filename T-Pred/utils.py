...
def build_encoder_graph_t(cell_type, inputs, t, hidden_size, num_layers, batch_size, num_steps, keep_prob, is_training,
                          name):
    def make_cell():
...
def conv1d(name, input_dim, output_dim, filter_size, inputs, stride=1, he_init=True, weightnorm=None, gain=1.,
           biases=True):
    '''
