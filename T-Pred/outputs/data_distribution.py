...
def plot_distribution(pred, target):
    ...
    n, bins, patches1 = ax.hist(pred, bins=40, density=True, label='pred', facecolor='lightseagreen',
                                edgecolor="black")
    sns.kdeplot(pred, shade=True, color='lightseagreen')
    n, bins, patches2 = ax.hist(target, bins=40, density=True, label='target', facecolor='lightcoral',
                                edgecolor="black",
                                alpha=0.75)
...
# filename = 'output-final-1018.txt' # NO!!!
